...
impl Client {
    ...
    /// Creates a new client when passed a Client ID, Client Secret and reqwest Client. Client Id 
    /// and Client Secret can be obtained by creating a connected app in Salesforce. reqwest Client
    /// can be created by user which allows user to set values like timeout. 
    pub fn new_client(client_id: Option<String>, client_secret: Option<String>, http_client: reqwest::Client) -> Self 
    {
        Client {
            http_client,
            client_id,
